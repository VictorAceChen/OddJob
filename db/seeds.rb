...
job2 = Job.create(
	...
	jobtype:	"Part-Time",
	salary:	900000,
	description: "We have a part-time opening for a Cleaning Professionals - Part-Time.
...
job3 = Job.create(
	...
	jobtype:	"Part-Time",
	salary:	25000,
	description: "We are looking for candidates that are as passionate about the growth and development of the precious children in our care as we are. keywords: teacher,teaching, preschool teacher, infant teacher, toddler teacher,
two'steacher, pre-k teacher, prekindergarten teacher, early childhood teacher,

earlychildhood educator, early childhood education, child development, child

developmentassociate, daycare teacher, day care teacher, childcare teacher,

child careteacher, full time teacher, part time teacher, experienced teacher,
